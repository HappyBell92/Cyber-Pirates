...
public class Dialogue : MonoBehaviour
{
    ...
    public class Monologue : DialogueSection
    {
        ...
        public Monologue(string speakerName = "Default_Speaker", string content = "There is nothing here...", DialogueSection next = null)
        {
    ...
    public class Choices : DialogueSection
    {
        ...
        public Choices(string speakerName = "Default_Speaker", string content = "There is nothing here, make a choice...", List<Tuple<string, DialogueSection>> choices = null)
        {
            this.speakerName = speakerName;
            this.content = content;
